...
![](https://camo.githubusercontent.com/30c4bef0204de307d1c413e18fffcfcad6fdbe4ce03677c4d4493d3742943a0d/68747470733a2f2f696d6775722e636f6d2f7652334c6d76302e706e67 align="left")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1740657706728/f4ec6698-af0a-4793-ae55-7f3284e81d50.png align="center")

Diagrams created by [Excalidraw](https://excalidraw.com/#json=otqFU25B2sSjweA4Sbq9l,7-eY_bzFrGAXLNkOVpQ2Tg).

## [Why Did](https://www.npmjs.com/package/kkrpc) [I Cr](https://jsr.io/@kunkun/kkrpc/doc)[eate](https://kunkunsh.github.io/kkrpc/) [it?](https://jsr.io/@kunkun/kkrpc/doc)

[This project w](https://jsr.io/@kunkun/kkrpc/doc)a[s created for another](https://kunkunsh.github.io/kkrpc/) bigger project [Kunkun](https://kunkun.sh/).
...
> Comlink makes [WebWorkers](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) [enjoyable](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API). Comlink is a **tiny library (1.1kB)**, that removes the mental barrier of thinking about `postMessage` and hides the fact that you are working with workers.
> 
...
![Comlink in action](https://user-images.githubusercontent.com/234957/54164510-cdab2d80-4454-11e9-92d0-7356aa6c5746.png align="left")
...
<div data-node-type="callout-text">Each end of the channel can expose different APIs, simply pass the 2 API interfaces as generics to <code>RPCChannel</code>. The following example shares the same API interface for both sides to keep the sample short.</div>
</div>
